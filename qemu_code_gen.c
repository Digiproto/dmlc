...
static void gen_register_struct(device_attr_t *dev,register_attr_t *reg,FILE* f){
	char *type = "uint32_t";
	fprintf(f,"\t\t%s %s;\n",type,reg->name);
}
...
static void gen_register_write_access(device_attr_t *dev,register_attr_t *reg,FILE* f){
...
static void gen_registers_access(device_attr_t *dev,bank_attr_t *b,FILE *f){
	register_attr_t *reg;
...
static void gen_bank_read_access(device_attr_t *dev,bank_attr_t *b,FILE *f){
...
static void gen_bank_write_access(device_attr_t *dev,bank_attr_t *b,FILE *f){
...
static void gen_memory_region(device_attr_t *dev,FILE *f){
	...
	char *endian = (dev->endian == LITTLE_ENDIAN_T) ? "DEVICE_LITTLE_ENDIAN":"DEVICE_BIG_ENDIAN";
	for(; l; l = l->next){
		b = l->bank;
...
static void gen_register_reset(device_attr_t *dev,register_attr_t *reg,FILE* f,int n){
...
static void gen_bank_reset(device_attr_t *dev,bank_attr_t *bank,FILE* f,int n){
